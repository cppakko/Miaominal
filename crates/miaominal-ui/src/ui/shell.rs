...
pub(in crate::ui::shell) use state::{
    ...
    PendingAiProviderPopupState, PendingChatSessionDeleteState, PendingKnownHostDeleteState,
    ...
    SecretVisibilityState, SessionAgentMessage, SessionAgentMessageRole,
