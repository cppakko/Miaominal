...
impl AppView {
    ...
    fn render_session_monitor_panel(
        ...
        let content = if !monitoring.auto_collect_enabled {
            v_flex()
                .size_full()
                .flex_1()
                .items_center()
            ...
            v_flex()
                ...
                .child(self.render_monitor_chart_card(MonitorChartCardConfig {
                    ...
                    value: format_rate_label(snapshot.network_rx_kbps + snapshot.network_tx_kbps),
                ...
                .child(self.render_monitor_chart_card(MonitorChartCardConfig {
                    ...
                    y_tick_labels: build_chart_tick_labels(&load_y_ticks, format_load_label),
                    palette_index: 4,
                }))
                .into_any_element()
        } else {
