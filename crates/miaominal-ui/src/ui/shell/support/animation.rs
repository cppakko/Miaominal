...
pub(in crate::ui::shell) fn render_basic_dialog(
    ...
    render_basic_dialog_with_config(
        ...
        BasicDialogConfig {
            ...
            actions,
            icon: None,
            header_alignment: BasicDialogHeaderAlignment::Start,
            exit_progress,
        },
    )
}

pub(in crate::ui::shell) struct BasicDialogConfig {
    pub title: String,
    pub supporting_text: Option<String>,
    pub body: Option<AnyElement>,
    pub actions: AnyElement,
    pub icon: Option<BasicDialogIcon>,
    pub header_alignment: BasicDialogHeaderAlignment,
    pub exit_progress: Option<f32>,
}

pub(in crate::ui::shell) fn render_basic_dialog_with_config(
    stable_key: impl AsRef<str>,
    config: BasicDialogConfig,
) -> AnyElement {
    let BasicDialogConfig {
        title,
        supporting_text,
        body,
        actions,
