...
pub(in crate::ui::shell) enum DialogOverlaySnapshot {
    ...
    SyncUnsafeWriteConsent(PendingSyncUnsafeWriteConsentState),
    LocalVaultDisableConfirm(PendingLocalVaultDisableConfirmState),
    LocalDataResetConfirm(PendingLocalDataResetConfirmState),
    SshBridgePolicyDowngrade(PendingSshBridgePolicyDowngradeState),
...
impl DialogOverlaySnapshot {
    pub(in crate::ui::shell) fn stable_key(&self) -> String {
        match self {
            ...
            Self::SyncUnsafeWriteConsent(_) => "sync-unsafe-write-consent".to_string(),
            ...
            Self::SshBridgePolicyDowngrade(_) => "ssh-bridge-policy-downgrade".to_string(),
