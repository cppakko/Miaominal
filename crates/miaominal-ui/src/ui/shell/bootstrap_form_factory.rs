...
pub(in crate::ui::shell) struct PanelFormsArgs {
    ...
    pub ai_provider_temperature_input: Entity<InputState>,
    pub ai_provider_max_tokens_input: Entity<InputState>,
    pub ai_provider_context_window_input: Entity<InputState>,
