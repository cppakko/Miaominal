    ...
    pub fn new(runtime: TokioHandle, window: &mut Window, cx: &mut Context<Self>) -> Self {
                ...
                && !modifiers.shift
            {
                ...
                view.update(cx, |this, cx| {
                    if let Some(mode) = this.local_vault_passphrase_popup {
                        ...
                        submitted_popup = true;
                    } else if this.web_search_config_popup.is_some() {
        ...
        let mut view = Self {
            ...
            workspace_state: WorkspaceState {
                ...
                sftp_progress_center_scroll_handle: ScrollHandle::new(),
                ...
                session_sftp_progress_center_flex: SESSION_SFTP_PROGRESS_DEFAULT_FLEX,
                session_sftp_progress_center_drag: None,
                terminal_originated_selection_drag: None,
                session_agent_auto_scroll: None,
                session_agent_auto_scroll_generation: 0,
                session_agent_text_drag_origin: None,
                session_agent_text_drag_conversation: None,
                session_agent_text_drag_paused_tail: false,
                session_agent_background_projection_active: false,
            },
