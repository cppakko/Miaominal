...
pub(in crate::ui::shell) struct SettingsForms {
    pub(in crate::ui::shell) language_select: Entity<SelectState<Vec<AppLanguage>>>,
    pub(in crate::ui::shell) last_tab_close_behavior_select:
        Entity<SelectState<Vec<LastTabCloseBehavior>>>,
    pub(in crate::ui::shell) local_vault_auto_lock_duration_select:
        Entity<SelectState<Vec<LocalVaultAutoLockDuration>>>,
    pub(in crate::ui::shell) monitor_history_select:
        Entity<SelectState<Vec<MonitorHistoryDuration>>>,
    pub(in crate::ui::shell) terminal_right_click_behavior_select:
        Entity<SelectState<Vec<TerminalRightClickBehavior>>>,
    pub(in crate::ui::shell) profile_import_source_select:
        Entity<SelectState<Vec<ImportSourceKind>>>,
    pub(in crate::ui::shell) sync_provider_select: Entity<SelectState<Vec<SyncProvider>>>,
