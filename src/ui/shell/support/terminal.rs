...
use crate::settings::{self as app_settings};
use crate::terminal::{
...
pub(in crate::ui::shell) use crate::domain::terminal::{TerminalKeyEvent, TerminalKeyPhase};
...
pub(in crate::ui::shell) fn classify_terminal_key(
    ...
    if event.phase == TerminalKeyPhase::Press {
        let bindings = app_settings::current_settings().key_bindings;
