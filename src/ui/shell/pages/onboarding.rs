use super::super::*;
use crate::settings::{AppLanguage, TerminalRightClickBehavior, ThemeId};
...
impl AppView {
    pub(in crate::ui::shell) fn render_onboarding_page(
        ...
        let current_material =
            settings::Theme::from_settings(self.settings_store.settings()).material;
...
fn render_onboarding_step_header(step: OnboardingStep) -> AnyElement {
    ...
    div()
        ...
        .child(
            div()
                .text_size(settings::scaled_font_size(30.0))
...
fn render_onboarding_preferences_step(
    ...
    terminal_right_click_behavior_select: Entity<SelectState<Vec<TerminalRightClickBehavior>>>,
...
fn onboarding_right_click_behavior_control(
    select_state: Entity<SelectState<Vec<TerminalRightClickBehavior>>>,
) -> AnyElement {
    Select::new(&select_state)
        .with_size(gpui_component::Size::Medium)
        .w_full()
