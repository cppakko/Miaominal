...
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub(crate) struct SnippetsDocument {
    #[serde(default)]
...
impl SessionStore {
    ...
    pub(crate) fn read_sessions_content(&self) -> Result<Option<String>> {
    ...
    pub(crate) fn parse_sessions(&self, content: &str) -> Result<Vec<SessionProfile>> {
...
mod tests {
    use super::*;
    use crate::domain::profile::{AuthMethod, PortForwardKind, PortForwardRule};
