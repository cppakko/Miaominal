...
use crate::domain::forwarding::{AgentIdentitySummary, KbiChallenge, KbiPrompt};
use crate::domain::profile::{AuthMethod, SessionProfile};
...
pub(crate) fn hydrate_profile_from_secrets(
