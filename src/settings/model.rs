use crate::ui::theme::{self as material_theme, MaterialTheme};
...
pub(crate) use crate::domain::settings::{DEFAULT_CELL_WIDTH, DEFAULT_FONT_SIZE};
...
pub(crate) fn changed(a: &AppSettings, b: &AppSettings) -> bool {
